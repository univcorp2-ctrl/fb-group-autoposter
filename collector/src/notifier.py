"""Minimal Telegram notifier for the collector role (self-contained).

Best-effort: no-ops when unconfigured, never raises into the caller.
"""
...
class TelegramNotifier:
    ...
    def send_message(self, text: str) -> bool:
        ...
        try:
            ...
            return True
        except Exception as exc:  # noqa: BLE001 - notification must never crash a run
